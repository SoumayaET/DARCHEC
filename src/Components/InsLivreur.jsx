...
const InsLivreur = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert("Formulaire Livreur envoyé !");
  };

  const handleLoginClick = () => {
    alert("Redirection vers la page de connexion Livreur...");
  };

  return (
    <div className="page page-livreur">
      <h1 className="titre">Bienvenue dans votre espace Livreur</h1>
      <div className="carte">
        <img src="/Logo30.jpg" alt="Livreur" className="logo" />
